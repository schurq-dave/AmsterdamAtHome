...
interface Verkoop5StappenProps {
  heading: string;
  steps: Verkoop5StappenStep[];
}

export function Verkoop5Stappen({ heading, steps }: Verkoop5StappenProps) {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        if (entries[0].isIntersecting) {
          setHasStarted(true);
          // Optional: stop observing once started if you only want it to trigger once
          // observer.disconnect();
        } else {
          // Optional: pause or reset when scrolled out of view
          // setHasStarted(false); 
        }
      },
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 reveal">
