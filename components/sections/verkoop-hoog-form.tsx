...
interface VerkoopHoogFormProps {
  heading: string;
  description: string;
  contact: {
...
export function VerkoopHoogForm({
  heading,
  description,
  contact,
}: VerkoopHoogFormProps) {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 max-w-5xl">
        <h2 className="text-3xl md:text-5xl font-serif text-boutique-dark mb-4 text-center reveal">
          {heading}
        </h2>
        <p className="text-gray-600 font-light text-lg text-center mb-16 max-w-2xl mx-auto reveal">
          {description}
        </p>
              ...
              >
                ...
                <div>
                  <label
                    ...
                    className="block text-[10px] font-bold uppercase tracking-[0.2em] font-sans text-gray-500 mb-2"
                  >
                    Bericht / Vraag / Toelichting / Opmerking
                  </label>
                  <textarea
                    id="vh-bericht"
                    rows={5}
